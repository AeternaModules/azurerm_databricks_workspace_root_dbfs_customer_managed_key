output "databricks_workspace_root_dbfs_customer_managed_keys_id" {
  ...
  value       = { for k, v in azurerm_databricks_workspace_root_dbfs_customer_managed_key.databricks_workspace_root_dbfs_customer_managed_keys : k => v.id if v.id != null && length(v.id) > 0 }
}
output "databricks_workspace_root_dbfs_customer_managed_keys_key_vault_id" {
  ...
  value       = { for k, v in azurerm_databricks_workspace_root_dbfs_customer_managed_key.databricks_workspace_root_dbfs_customer_managed_keys : k => v.key_vault_id if v.key_vault_id != null && length(v.key_vault_id) > 0 }
}
output "databricks_workspace_root_dbfs_customer_managed_keys_key_vault_key_id" {
  ...
  value       = { for k, v in azurerm_databricks_workspace_root_dbfs_customer_managed_key.databricks_workspace_root_dbfs_customer_managed_keys : k => v.key_vault_key_id if v.key_vault_key_id != null && length(v.key_vault_key_id) > 0 }
}
output "databricks_workspace_root_dbfs_customer_managed_keys_workspace_id" {
  ...
  value       = { for k, v in azurerm_databricks_workspace_root_dbfs_customer_managed_key.databricks_workspace_root_dbfs_customer_managed_keys : k => v.workspace_id if v.workspace_id != null && length(v.workspace_id) > 0 }
}
